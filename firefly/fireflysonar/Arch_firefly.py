...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     sonar >> Edge( label='obstacleDetected', **eventedgeattr, decorate='true', fontcolor='red') >> sys
     sonar >> Edge( label='obstacleClear', **eventedgeattr, decorate='true', fontcolor='red') >> sys
     sys >> Edge( label='obstacleDetected', **evattr, decorate='true', fontcolor='darkgreen') >> firefly1
     sys >> Edge( label='obstacleClear', **evattr, decorate='true', fontcolor='darkgreen') >> firefly1
     sys >> Edge( label='obstacleDetected', **evattr, decorate='true', fontcolor='darkgreen') >> firefly2
     sys >> Edge( label='obstacleClear', **evattr, decorate='true', fontcolor='darkgreen') >> firefly2
     sys >> Edge( label='obstacleDetected', **evattr, decorate='true', fontcolor='darkgreen') >> firefly3
     sys >> Edge( label='obstacleClear', **evattr, decorate='true', fontcolor='darkgreen') >> firefly3
